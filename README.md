...
> 💡 **提示**：为避免在部分 Markdown 阅读器中因 GIF 体积过大、网络限制或路径问题导致动态图无法加载，下方矩阵已全部使用**静态高清封面图（Poster）**展示，确保极速加载，稳定不卡顿。
...
| **[basketball](./basketball/)** <br>*(Sunk Dunk 3D 运动商店)* | **程序化 3D 篮球交互**。随滚动叙事线旋转缩放，带加购飞入购物车特效、球鞋 3D 定制器及音效反馈。<br>**技术栈**：React + TS + Three.js (@react-three/fiber) + GSAP | <img src="./basketball/basketball.poster.jpg" width="320" style="border-radius:10px;" alt="basketball 预览"> |
